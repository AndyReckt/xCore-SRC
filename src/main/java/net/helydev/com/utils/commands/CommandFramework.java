...
public class CommandFramework implements CommandExecutor {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (!command.permission().equals("")) {
                    if (command.permission().equalsIgnoreCase("op") && !sender.isOp()) {
                        sender.sendMessage(Color.translate(xCore.getPlugin().getMessageconfig().getConfiguration().getString("basic.no-permission")));
                        return false;
                    }
                ...
                if (command.inGameOnly() && !(sender instanceof Player)) {
                    sender.sendMessage(Color.translate(xCore.getPlugin().getMessageconfig().getConfiguration().getString("basic.only-players")));
                    return true;
                }
                try {
    ...
    private void defaultCommand(CommandArgs args) {
        args.getSender().sendMessage("Sorry, /" + args.getLabel() + " is not supported.");
    }
