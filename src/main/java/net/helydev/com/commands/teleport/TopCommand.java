...
public class TopCommand {
    ...
    public boolean TopCommand(CommandArgs command) {
        Player player = command.getPlayer();
        String[] args = command.getArgs();
        final Player entity = (Player)player;
        final Location destination = BukkitUtils.getHighestLocation(entity.getLocation());
        if (destination != null) {
